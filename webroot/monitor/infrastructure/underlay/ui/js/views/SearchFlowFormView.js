define([
    ...
    var SearchFlowFormView = QueryFormView.extend({
        render: function() {
            ...
            self.$el.append(queryPageTmpl({prefix: ctwc.UNDERLAY_SEARCHFLOW_TAB_ID }));
            ...
            self.renderView4Config($(self.$el).find(queryFormId), this.model, self.getViewConfig(), null, null, null, function () {
                ...
                Knockback.applyBindings(self.model, document.getElementById(ctwc.UNDERLAY_SEARCHFLOW_TAB_ID));
        ...
        renderQueryResult: function() {
            var self = this,
                queryResultId = "#" + ctwc.UNDERLAY_SEARCHFLOW_TAB_ID + "-results",
                responseViewConfig = {
                            ...
                            columns: [
                                {
                                    ...
                                    viewConfig: {path: 'where', dataBindValue: 'where', class: "span5", placeHolder: "*", editPopupConfig: {
                                    ...
                                    viewConfig: {
                                        ...
                                        elementConfig: {dataTextField: "text", dataValueField: "id", data: ctwc.TIMERANGE_DROPDOWN_VALUES}}
                                },{
                                    elementId: 'from_time', view: "FormDateTimePickerView",
                                    viewConfig: {
                                        style: 'display: none;',
                                        path: 'from_time', dataBindValue: 'from_time', class: "span2",
                                    ...
                                    viewConfig: {
                                        style: 'display: none;',
                                        path: 'to_time', dataBindValue: 'to_time', class: "span2",
                                    ...
                                    viewConfig: {
                                        path: 'limit', dataBindValue: 'limit', class: "span1",
                                        elementConfig: {
                                            dataTextField: "text",
                                            dataValueField: "id",
                                            data:[{
