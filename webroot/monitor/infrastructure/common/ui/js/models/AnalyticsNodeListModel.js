define(['contrail-list-model','monitor-infra-parsers'], function(ContrailListModel, MonitorInfraParsers) {
    ...
    var AnalyticsNodeListModel = function() {
        ...
        var listModelConfig = {
            remote : {
                ...
                dataParser : monInfraParsers.parseAnalyticsNodesDashboardData
            },
            vlRemoteConfig : {
                vlRemoteList : [{
