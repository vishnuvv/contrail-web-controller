    ...
    var DatabaseNodesSummaryChartsView = ContrailView.extend({
        render : function (){
            var self = this,
                ...
                self.renderView4Config(self.$el.find('.gs-container'),{},getGridStackWidgetConfig(colorFn,self.model));
        }
    });
    
    function getGridStackWidgetConfig(colorFn, databaseNodeModel) {
