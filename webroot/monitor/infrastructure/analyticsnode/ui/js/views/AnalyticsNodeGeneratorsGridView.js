        ...
        render: function () {
            ...
            var remoteAjaxConfig = {
                    remote: {//TODO need to verify if the pagination is actually working
                        ajaxConfig: {
                            url: contrail.format(monInfraConstants.monitorInfraUrls['ANALYTICS_GENERATORS'], hostname, 50),
                            type: "GET",
                        },
            ...
            self.renderView4Config(this.$el, contrailListModel, getAnalyticsNodeGeneratorsViewConfig(viewConfig));
        }
    });
