...
define(['underscore', 'contrail-view', 'monitor-infra-analyticsnode-model', 'node-color-mapping'],
        function(_, ContrailView, AnalyticsNodeListModel, NodeColorMapping){
    var ConfigNodeViewConfig = function () {
        ...
        var self = this;
        var viewConfig = {
            'analyticsnode-charts-view': function (){
                return {
                    modelCfg: null,
                    viewCfg: {
