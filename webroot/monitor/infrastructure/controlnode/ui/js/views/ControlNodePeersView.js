...
define([
    ...
    'contrail-list-model'
], function (_, ContrailView, MonitorInfraParsers, MonitorInfraConstants, ContrailListModel) {
    var monInfraParsers = new MonitorInfraParsers ();
    var monInfraConstants = new MonitorInfraConstants();
    var hostname;
    var ControlNodesPeersView = ContrailView.extend({
        el: $(contentContainer),
        ...
        render: function () {
            ...
            var remoteAjaxConfig = {
                    remote: {//TODO need to verify if the pagination is actually working
                        ajaxConfig: {
                            url: contrail.format(monInfraConstants.monitorInfraUrls['CONTROLNODE_PEERS'], hostname, 40),
                            type: "GET",
                        },
            ...
            self.renderView4Config(this.$el, contrailListModel, getControlNodePeersViewConfig(viewConfig));
        }
    });
