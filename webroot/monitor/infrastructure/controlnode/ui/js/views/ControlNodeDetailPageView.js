        ...
        return {
            ...
            viewConfig: {
                ...
                dataParser: function(result) {
                    ...
                    obj['analyticsNodeDetails'] = getAnalyticsNodeDetails(ctrlNodeData);
                    
                    obj['analyticsMessages'] = getAnalyticsNodeMessageInfo(ctrlNodeData);
                    
                    obj['peersDetails'] = getPeersDetails(obj);
                    
                    obj['vRouterPeerDetails'] = getVRouterPeersDetails(ctrlNodeData,obj);
                    
                    obj['lastLogTimestamp'] = getLastLogTime(ctrlNodeData);
