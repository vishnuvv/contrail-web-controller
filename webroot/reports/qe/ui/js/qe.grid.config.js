...
define([
    ...
    var columnDisplayMap  = {
        "FlowSeriesTable": [
            ...
            {select:"dport", display:{id:"dport", field:"dport", width:130, name:"Destination Port", groupable:false, formatter: function(r, c, v, cd, dc){ return handleNull4Grid(dc.dport);}}},
            ...
            {select:"sum(bytes)", display:{id:"sum(bytes)", field:"sum(bytes)", width:100, name:"SUM (Bytes)", format:"{0:n0}", groupable:false}},
            {select:"avg(bytes)", display:{id:"avg(bytes)", field:"avg(bytes)", width:100, name:"AVG (Bytes)", format:"{0:n0}", groupable:false}},
